...
const _lazy_ZPUE9T = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_ZPUE9T, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ZPUE9T, lazy: true, middleware: false, method: undefined }
];
